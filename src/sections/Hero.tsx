...
export const HeroSection = () => {
  return (
    <section className="py-32 md:py-48 lg:py-60">
      <div className="absolute inset-0 top-10 md:top-0  [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] md:[mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]  overflow-x-clip">
